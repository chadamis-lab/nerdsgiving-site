...
function FloatingGlyph({ className, children, duration = 8, delay = 0 }) {
  return (
    <div
...
function D20Icon() {
  return (
    ...
    >
      <defs>
        <linearGradient id="d20Fill" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default function NerdsgivingPage() {
  ...
  const glyphs = useMemo(() => {
    const allGlyphs = [
      { id: "controller", className: "left-[6%] top-[8%] text-2xl text-violet-300/90 hidden sm:block", symbol: "🎮", duration: 9, delay: 0.2 },
      { id: "spark", className: "left-[10%] top-[42%] text-5xl text-fuchsia-300/55 hidden sm:block", symbol: "✦", duration: 7, delay: 0.8 },
      { id: "infinity", className: "left-[24%] top-[26%] text-3xl text-emerald-300/80", symbol: "∞", duration: 8.5, delay: 0.4 },
      { id: "command", className: "right-[8%] top-[14%] text-xl text-violet-200/60 hidden sm:block", symbol: "⌘", duration: 10, delay: 0.1 },
      { id: "bolt", className: "right-[8%] top-[34%] text-5xl text-fuchsia-400/80", symbol: "⚡", duration: 7.5, delay: 1.1 },
      { id: "wand", className: "left-[42%] top-[58%] text-5xl text-fuchsia-300/35 hidden sm:block", symbol: "🪄", duration: 9.5, delay: 0.5 },
      { id: "square", className: "left-[58%] top-[74%] text-4xl text-violet-200/30 hidden sm:block", symbol: "▣", duration: 8.8, delay: 0.7 },
      { id: "rook", className: "right-[20%] bottom-[24%] text-5xl text-emerald-300/70", symbol: "♜", duration: 8.2, delay: 0.3 },
      { id: "ring", className: "right-[6%] bottom-[10%] text-3xl text-cyan-300/55 hidden sm:block", symbol: "◎", duration: 9.2, delay: 0.9 },
      { id: "d20", className: "left-[12%] bottom-[18%] text-amber-200/65", symbol: <D20Icon />, duration: 8.7, delay: 0.6 },
      { id: "puzzle", className: "right-[18%] top-[52%] text-3xl text-cyan-200/50 hidden sm:block", symbol: "🧩", duration: 9.8, delay: 0.4 },
      { id: "alien", className: "left-[18%] top-[18%] text-3xl text-fuchsia-200/45 hidden sm:block", symbol: "👾", duration: 7.9, delay: 1.2 },
      { id: "ufo", className: "right-[28%] top-[8%] text-2xl text-emerald-200/45 hidden sm:block", symbol: "🛸", duration: 10.4, delay: 0.5 },
      { id: "brain", className: "left-[8%] top-[70%] text-3xl text-cyan-200/55 hidden sm:block", symbol: "🧠", duration: 8.9, delay: 0.2 },
      { id: "target", className: "right-[12%] top-[68%] text-3xl text-violet-200/55 hidden sm:block", symbol: "🎯", duration: 9.1, delay: 0.7 },
    ]
